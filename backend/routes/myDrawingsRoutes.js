...
router.post('/workers/:id/add-site', requireMyDrawingsPin, requireMyDrawingsAdmin, ctrl.addWorkerSiteAccess);
router.post('/workers/:id/revoke-site', requireMyDrawingsPin, requireMyDrawingsAdmin, ctrl.revokeWorkerSiteAccess);
