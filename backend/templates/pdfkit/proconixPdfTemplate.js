/**
 * Conflow PDFKit template — single file: Time Sheet Report + Work Report.
...
function drawFooter(doc, pageW, pageH) {
  ...
  doc.text('Generated by Conflow Work Reports', MARGIN, pageH - 26, {
...
function renderTimesheet(doc, opts) {
  ...
  doc.text('Generated by Conflow Work Reports', MARGIN, 74);
  doc.restore();
