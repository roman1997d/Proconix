  ...
  function generateAndUploadWorkReport() {
    ...
    function generateTimesheetPdfClientSide() {
      ...
      return readAllJobPhotos().then(function () {
        ...
        doc.setFontSize(16);
        doc.text('Conflow Time Sheet Report', margin + 24, 16);
        doc.setFont('helvetica', 'normal');
        doc.setFontSize(10);
        doc.text('Generated by Conflow', pageW - margin, 16, { align: 'right' });
        ...
        return Promise.all(
          ...
          for (var pn = 1; pn <= pages; pn++) {
            ...
            doc.setFontSize(9);
            doc.setFont('helvetica', 'normal');
            doc.text('Generated by Conflow Work Reports', pageW / 2, pageH - 12, { align: 'center' });
